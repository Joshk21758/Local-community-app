...
export type AutomatedPermitPolicyCheckInput = z.infer<typeof AutomatedPermitPolicyCheckInputSchema>;
...
export type AutomatedPermitPolicyCheckOutput = z.infer<typeof AutomatedPermitPolicyCheckOutputSchema>;

export async function automatedPermitPolicyCheck(
  input: AutomatedPermitPolicyCheckInput
): Promise<AutomatedPermitPolicyCheckOutput> {
