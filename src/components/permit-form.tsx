...
import {
  automatedPermitPolicyCheck,
  type AutomatedPermitPolicyCheckOutput,
} from '@/ai/flows/automated-permit-policy-check';
...
const formSchema = z.object({
  permitType: z.enum(['Building', 'Event', 'Business'], {
...
export function PermitForm() {
  ...
  const [aiResult, setAiResult] = useState<AutomatedPermitPolicyCheckOutput | null>(null);
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast({
        ...
        description: 'Your permit application has been sent for review.',
      });
    } catch (error) {
      toast({
        variant: 'destructive',
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Provide a clear and concise description of the proposed work
                  or event.
                </FormDescription>
                <FormMessage />
              </FormItem>
